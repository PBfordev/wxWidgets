...
xcopy %1imagemap.png %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1pic.png %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1pic2.bmp %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1i18n.gif %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1imagemap.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1tables.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1test.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1listtest.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %18859_2.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1cp1250.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1regres.htm %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1foo.png %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy

xcopy %1subsup.html %2 /D /Y /Q > nul
IF %ERRORLEVEL% NEQ 0 GOTO err_copy
